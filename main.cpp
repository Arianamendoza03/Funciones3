...
//"Hola Ariana, tu tienes 28 años, 2 meses y 13 días de edad."
...
int main() {
    ...
    string edad= edadEnDiasMesesyAnios( 3, 1, 2001, "Ariana Mendoza");
    cout<<endl<<edad;
    ...
    cout<<endl<<saludos("Ariana");
    cout<<endl<<saludos();
    cout<<endl<<saludos("Ricky");
    cout<<endl<<saludos("Piero", 20);
